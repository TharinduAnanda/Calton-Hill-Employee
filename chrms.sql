...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2025 at 05:18 AM
...
INSERT INTO `customer` (`ID`, `NAME`, `EMAIL`, `PHONE_NUM`, `PASSWORD`, `resetToken`, `resetTokenExpiry`, `createdAt`, `updatedAt`) VALUES
(1, 'Tharindu Lalanath Ananda', 'tharindulalanath49@gmail.com', '1234567890', '$2b$10$0IYi9qJj0gVI0VToI5p7sewUSZV0Wekq2pVCRScNc7M7uUrAOcK6e', NULL, NULL, '2025-02-25 23:52:37', '2025-02-25 23:52:37'),
(2, 'Manel Ananda', 'manel@gmail.com', '0712128692', '$2b$10$ppudb7f1S5V4Ztnpb4QZWeEfJdGx.sxqhpgKTe2v4Y76Rd31gauMy', NULL, NULL, '2025-03-04 21:48:13', '2025-03-04 21:48:13'),
(3, 'Kanishka Ananda', 'anandae-im21040@stu.kln.ac.lk', '0717577400', '$2b$10$1B7fTOK/NeDowX/syrZfPuhxhuhvZAvFEENBgIO0OUVmjEmzCrpnm', NULL, NULL, '2025-03-19 07:11:04', '2025-03-19 07:11:04'),
(4, 'Lakshitha Sampath', 'lakshitha@gmail.com', '0717577400', '$2b$10$yE1w9NXTu.lBgR7UJOdok.g7d3LvX5CcPqCdCFGE/8uo/DFx1ozEu', NULL, NULL, '2025-03-25 11:46:38', '2025-03-25 11:46:38'),
(5, 'dhanuka Wimalarathana', 'dhanuka@gmail.com', '0717577400', '$2b$10$KxqeGQUVird4Bjn1fbo5XuFzHeYRBvJ731f.60MfpuwPmqfyCRuaa', NULL, NULL, '2025-03-25 11:47:47', '2025-03-25 11:47:47'),
(6, 'Test User', 'test@example.com', '1234567890', '$2b$10$9zRuSHe5PbxNEpcQsRhZi.HSF3n/m6LTvJWtDxBSDVAQbMLyXKfOq', NULL, NULL, '2025-03-26 01:08:10', '2025-03-26 01:08:10'),
(7, 'kanishka dilhan', 'dilhan@gmail.com', NULL, '$2b$10$OHUKUH/2Rw02kwN.CiMege7A3DCBHvQFopJGDbtq8M32rrcqKi1ne', NULL, NULL, '2025-03-26 01:12:44', '2025-03-26 01:12:44');
...
(6, 'Admin', 'admin@example.com', '$2b$10$ljaacwEMH0GMq1leUpMAmOP6emqTlpjrkqLkQqvDLk6RrvvNLpGZu', NULL, NULL);
...
INSERT INTO `product` (`Product_ID`, `Name`, `Category`, `Stock_Level`, `Manufacturer`, `Image_URL`, `Supplier_ID`, `Price`, `image_public_id`) VALUES
(1, 'Cordless Drill', 'Power Tools', 25, 'Bosch', 'https://asset.cloudinary.com/djy8hclco/778366066797462f6a21f3d7291ce4bc', NULL, 12999, '1_y4ivw6'),
(2, 'Claw Hammer', 'Hand Tools', 50, 'Stanley', 'https://res.cloudinary.com/your-cloud/image/upload/v12345/hammer.jpg', NULL, 2499, ''),
(3, 'Adjustable Wrench', 'Plumbing', 40, 'Crescent', 'https://res.cloudinary.com/your-cloud/image/upload/v12345/wrench.jpg', NULL, 1799, ''),
(4, 'Circular Saw', 'Power Tools', 15, 'DeWalt', 'https://res.cloudinary.com/your-cloud/image/upload/v12345/saw.jpg', NULL, 18999, ''),
(5, 'Safety Gloves', 'Safety Gear', 100, '3M', 'https://res.cloudinary.com/your-cloud/image/upload/v12345/gloves.jpg', NULL, 899, ''),
(6, 'Paint Brushes Set', 'Painting', 30, 'Purdy', 'https://res.cloudinary.com/your-cloud/image/upload/v12345/brushes.jpg', NULL, 1499, ''),
(7, 'Steel Ladder', 'Access Equipment', 10, 'Werner', 'https://res.cloudinary.com/your-cloud/image/upload/v12345/ladder.jpg', NULL, 24999, ''),
(8, 'Voltage Tester', 'Electrical', 20, 'Klein Tools', 'https://res.cloudinary.com/your-cloud/image/upload/v12345/tester.jpg', NULL, 2999, ''),
(9, 'Toolbox', 'Storage', 35, 'Stanley', 'https://res.cloudinary.com/your-cloud/image/upload/v12345/toolbox.jpg', NULL, 5999, ''),
(10, 'Work Boots', 'Safety Gear', 45, 'Timberland PRO', 'https://res.cloudinary.com/your-cloud/image/upload/v12345/boots.jpg', NULL, 7999, '');
